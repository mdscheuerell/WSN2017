...
.botleft.small.white-text[Source: blog.fireflies.ai]
...
## .blue-text[Genetics] (genomic selection, eDNA)

## .blue-text[Remote sensing] (satellites, camera traps)

## .blue-text[Statistics] (hierarchical models)
...
# A state-space model is simply
# a model with 2 parts
...
## .gray-text[Missing data] are easily accommodated
...
# "I'm sold, but how do I actually do this?"
...
## .blue-text[Brew your own] (JAGS, Stan, greta)

.footnoteSm[<sup>1</sup>See Holmes, Ward & Scheuerell (2014) for *lots* of worked examples]
